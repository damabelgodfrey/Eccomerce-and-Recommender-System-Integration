...
<table class="table table-bordered table-condensed table-striped">
  <tbody><th>Action</th><th>Title</th><th>Caption</th><th>Link URL/Product</th><th>Flag</th><th>Status</th></thead>
<tbody>
    ...
    <tr>
      ...
      <td><a href = "slide?status=<?=(($slide['status']== 0)?'1':'0');?>&id=<?=$slide['id'];?>" class = "btn btn-xs <?=(($slide['status'] == 1)?'btn-success':'btn-default');?>">
        <span class = "glyphicon glyphicon-<?=(($slide['status']==1)?'minus':'plus');?>"></span>
      </a> <?=(($slide['status'] == 1)?'':'OFF');?></td>
