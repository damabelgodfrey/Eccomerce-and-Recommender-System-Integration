...
$return = mysqli_num_rows($itemQ);
  if($return == 1){
    ...
    if(isset($_POST['instorePurchase'])){
      ...
      (charge_id,cart_id,full_name,email,phone,street,street2,city,state,zip_code,country,items,sub_total,tax,grand_total,description,txn_type) VALUES
      ('$chargeId','$cart_id','$full_name','$email','$phone','$street','$street2','$city','$state','$zip_code','$country','$itemsOrdered','$sub_total','$tax','$grand_total','$description','$transactionType')");
      ...
      $db->query("INSERT INTO transactions
      (charge_id,cart_id,full_name,email,phone,street,street2,city,state,zip_code,country,items,sub_total,tax,grand_total,description,txn_type) VALUES
      ('$charge->id','$cart_id','$full_name','$email','$phone','$street','$street2','$city','$state','$zip_code','$country','$itemsOrdered','$sub_total','$tax','$grand_total','$description','$charge->object')");
    }
...
<div class="container-fluid">
  <div class="bg-danger">
    <p class="text-center text-info">
      Info Alert! You are seeing this information because you have submitted a transaction previously or
      you are refreshing the page or accesing this page directly on your browser.
    </p>
  </div>
