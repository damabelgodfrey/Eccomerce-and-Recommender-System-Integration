...
<div class="search-container">
 ...
 <table class="table table-bordered table-striped table-condensed table-hover">
   <thead class= "bg-primary"><th>Status</th><th>Name</th><th>Address</th><th>Charge</th>
     <th>
   ...
   <th>P_Date</th><th>Sub total</th><th>Tax</th><th>Grand Total</th></thead>
   <tbody>
     <?php
     ...
     <tr <?=(strcasecmp($userT['status'], 'Not Complete') == 0)? ' class="danger"':''?>>
       ...
       <td><?=$userT['full_name'];?><br><?=$userT['email'];?><br><?=$userT['phone'];?></td>
       <td>
         <address>
           <?=$userT['street'];?><br>
