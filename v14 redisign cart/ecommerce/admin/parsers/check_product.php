...
if(isset($_POST['product_id'])){
  ...
  $sizes = sizesToArray($product['sizes']); //function in helper file
    ...
    if($remain <0){
      $errors[] =$size['size'].$mysize.$quantity.$available.$remain.'Quantity or Size choosen is not availabel in stock. Click on View details and refresh page to get product available';
    }
  }else{
