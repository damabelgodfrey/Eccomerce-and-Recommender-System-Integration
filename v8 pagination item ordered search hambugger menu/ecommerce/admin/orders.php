...
<table class="table table-condesed table-bordered table-striped" id=orderTableHead1>
  <thead class= "bg-primary">
    <th>Title</th><th>Quantity</th><th>Category</th><th>Size</th>
  </thead>
  <tbody>
...
<div class='pull-right'>
 <a href="orderedItem.php" class="btn btn-large btn-default">Cancel</a>
 <a href="orders.php?complete=1&cart_id=<?=$cart_id;?>" class="btn btn-primary btn-large" onclick="return confirmC()">Complete Order</a>
 </div>
