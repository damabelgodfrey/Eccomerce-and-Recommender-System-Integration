<div class="nav-top">
  <div class="">
        <p></p><div class="pull-right"><a href="sales.php" class="btn btn-sm btn-danger">Click here to shop Ameritinz sales up to 50% off now..</a>  </div>
        <p></p><div class="pull-left"><a href="sales.php" class="btn btn-sm btn-primary">SHOP TRENDING..click here >></a>  </div>
  </div>
</div>
...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    ...
    <!--  <li><a class="fa fa-fw fa-home href="index.php">Home</a></li> -->
