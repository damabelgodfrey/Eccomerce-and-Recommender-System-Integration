...
if(isset($_POST['C_register'])){
  ...
  $permissions = '';
  $required = array('full_name','phone', 'email','password', 'confirm');
  $emailQuery = $db->query("SELECT * FROM customer_user WHERE email='$email'");
    ...
    if(!empty($errors)){
      ...
      //add to database
          ...
          $db->query("INSERT INTO customer_user (full_name,phone,email,password,permissions) values('$name','$phone','$email','$hashed','$permissions')");
...
<div class="container-fluid col-md-12">
      ...
      <div id='success'> </div>
      <a href="login.php" class="btn btn-lg btn-success btn-block form-control"> Return to Website</a>
    ...
    <?php }else{ ?>
     ...
     <form class="form-signin" method="POST">
       ...
       value="<?php echo isset($_POST["full_name"]) ? htmlentities($_POST["full_name"]) : ''; ?>" required autofocus>
     </div>
     <p></p>
     <div class="input-group">
