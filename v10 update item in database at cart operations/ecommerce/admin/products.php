    ...
    if($_POST && !isset($_POST['num_size'])){
      ...
      if(!empty($errors)){
        ...
        if(isset($_GET['edit'])){
          ...
          `brand` ='$brand', `categories` = '$category', `sizes` = '$sizes', `image` = '$dbpath', `description` = '$description', `p_keyword` = '$p_keyword'
          WHERE id='$edit_id'";
        }
       $db->query($insertSql);
       header('Location:products.php');
      ...
      <form action="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="POST" enctype="multipart/form-data">
       ...
       <div class ="form-group col-md-3">
        ...
        <div class="form-group col-md-6">
          <?php if($saved_image != ''): ?>
            <?php
             ...
             <a href="products.php?delete_all_image=1&edit=<?=$edit_id;?>" class="text-danger"><strong>Delete All Images</strong></a><hr>
             <?php foreach($images as $image) : ?>
                <div class="saved-image container-fluid col-md-4">
        ...
        <div class= "form-group col-md-3">
         ...
         <div class= "form-group col-md-3">
           <a href="products.php" class="btn btn-lg btn-default form-control">Cancel</a>
         </div>
      </form>
  </div>
      <!-- Sizes Modal -->
...
<tbody>
  ...
  ?>
    <tr>
      ...
      <td><?=$category;?></td>
      <td><a type="button" href = "products.php?featured=<?=(($product['featured']== 0)?'1':'0');?>&id=<?=$product['id'];?>" class = "btn btn-sm btn-default">
      ...
      <td>
        ...
        <span class="input-group-addon" id=""><a href ="products.php?reset=<?=$product['id'];?>" class= "btn btn-xs btn-warning" onclick="return resetconfirm()"><span  class="glyphicon glyphicon-refresh"></span><a/></span>
