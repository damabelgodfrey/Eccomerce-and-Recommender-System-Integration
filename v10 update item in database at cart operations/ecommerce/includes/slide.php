...
//var_dump($slideTitle2);var_dump($url); die();
  ...
  <div id="my-slider" class="carousel slide" data-ride="carousel">
    ...
    <!-- Wrapper for slides -->
    <div class="carousel-inner" role="listbox" id="myCarousal">
      <?php if (isset($arrayR[1])): ?>
        <div class="item active">
          <a href="<?=(isset($arrayR[1])?$slideUrl1:'');?>"><img src="<?=(isset($arrayR[1])?$slideImage1:'');?>"></a>
            <div class="carousel-caption">
              <a href="<?=(isset($arrayR[1])?$slideUrl1:'');?>"><h1 href="/Internet"><?=(isset($arrayR[1])?$slideCaption1:'');?></h1></a>
      ...
      <?php if(isset($arrayR[2])): ?>
        ...
        <a href="<?=(isset($arrayR[2])?$slideUrl2:'');?>"><img src="<?=(isset($arrayR[2])?$slideImage2:'');?>"></a>
          <div class="carousel-caption">
            <a href="<?=(isset($arrayR[2])?$slideUrl2:'');?>"><h1 href="/Internet"><?=(isset($arrayR[2])?$slideCaption2:'');?></h1></a>
          </div>
        </div>
      <?php endif; ?>
      ...
      <?php if (isset($arrayR[3])): ?>
        ...
        <a href="<?=(isset($arrayR[3])?$slideUrl3:'');?>"><img src="<?=(isset($arrayR[3])?$slideImage3:'');?>"></a>
          <div class="carousel-caption">
            <a href="<?=(isset($arrayR[3])?$slideUrl3:'');?>"><h1 href="/Internet"><?=(isset($arrayR[3])?$slideCaption3:'');?></h1></a>
          </div>
      </div>
      <?php endif; ?>
      ...
      <?php if (isset($arrayR[4])): ?>
        ...
        <a href="<?=(isset($arrayR[4])?$slideUrl4:'');?>"><img src="<?=(isset($arrayR[4])?$slideImage4:'');?>"></a>
          <div class="carousel-caption">
            <a href="<?=(isset($arrayR[4])?$slideUrl4:'');?>"><h1 href="/Internet"><?=(isset($arrayR[4])?$slideCaption4:'');?></h1></a>
          </div>
        </div>
      <?php endif; ?>
      ...
      <?php if (isset($arrayR[5])): ?>
        ...
        <a href="<?=(isset($arrayR[5])?$slideUrl5:'');?>"><img src="<?=(isset($arrayR[5])?$slideImage5:'');?>"></a>
          <div class="carousel-caption">
            <a href="<?=(isset($arrayR[5])?$slideUrl5:'');?>"><h1 href="/Internet"><?=(isset($arrayR[5])?$slideCaption5:'');?></h1></a>
          </div>
        </div>
      <?php endif; ?>
      ...
      <?php if (isset($arrayR[6])): ?>
        ...
        <a href="<?=(isset($arrayR[6])?$slideUrl6:'');?>"><img src="<?=(isset($arrayR[6])?$slideImage6:'');?>"></a>
          <div class="carousel-caption">
            <a href="<?=(isset($arrayR[6])?$slideUrl6:'');?>"><h1 href="/Internet"><?=(isset($arrayR[6])?$slideCaption6:'');?></h1></a>
          </div>
        </div>
      <?php endif; ?>
