...
if(isset($_GET['add']) || isset($_GET['edit'])){
  $PermissionQuery = $db->query("SELECT * FROM permissions"); //get brand from database
  ...
  if(isset($_GET['edit'])){
        ...
        if($proflag == 'false' && check_staff_permission('admin') && ((in_array('pro',$Edit_permissions,true) ||  in_array('admin',$Edit_permissions,true)))){
          $message = "Please! You do not have sufficient clearance to editjjj this staff.";
        permission_ungranted('users',$message);
        }else{
    ...
    if(!empty($errors)){
      ...
      //add to database
        ...
        if(isset($_GET['edit'])){
          ...
          $insertSql = "UPDATE users SET username ='$username1',full_name ='$name1', phone='$phone1', email ='$email1', permissions = '$permissions1',last_login ='$last_login'
          WHERE id='$edit_id'";
         ...
         $_SESSION['success_flash'] .= $name1. ' user has been updated!';
          ...
          $db->query("INSERT INTO users (username,full_name,phone,email,password,permissions) values('$username','$name','$phone','$email','$hashed','$permissions')");
        ...
        <div class="posts_list">
          ...
          <tr>
            <td>
              ...
              <?php if($user['username'] != $user_data['username']){ ?>
