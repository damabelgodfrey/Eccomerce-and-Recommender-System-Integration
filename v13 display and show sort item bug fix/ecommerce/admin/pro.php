      ...
      if(!empty($errors)){
        ...
        //upload file and insert into database
          for($i = 0; $i<$photoCount; $i++){
           ...
           $insertSql = "INSERT INTO products (`title`,`price`,`list_price`,`brand`,`categories`,`sizes`,`image`,`description`,`p_keyword`)
            VALUES ('$title','$price','$list_price','$brand','$category','$sizes','$dbpath','$description','$p_keyword')";
        if(isset($_GET['edit'])){
    ...
    <!-- if edit is clicked set the post option to edit id else set to add product( add=1)-->
      <form action="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="POST" enctype="multipart/form-data">
       ...
       <div class ="form-group col-md-3">
        ...
        <div class= "form-group col-md-3">
          <input type="submit" value="<?=((isset($_GET['edit']))?'Edit ':'Add ');?> Product" class="btn btn-lg btn-success form-control">
        </div>
         <div class= "form-group col-md-3">
