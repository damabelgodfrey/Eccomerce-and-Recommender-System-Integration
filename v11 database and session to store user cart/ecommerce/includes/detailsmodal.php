            ...
            <div class="col-md-6">
              ...
              <form action="add_cart.php" method="post" id="add_product_form">
                ...
                <div class="form-group">
                  ...
                  <textarea id="request" name="request"  class="form-control" maxlength="50" placeholder="Enter preference or special request e.g fragrance, colour etc" rows="2"></textarea>
                </div>
                <div class="form-group">
...
<div class="modal-footer">
 ...
 <?php if(is_logged_in()){
   ...
   echo '<a href="login.php" class="btn btn-warning" role="button">Login to add to cart</a>';
  } ?>
</div>
  </div>
</div>
