...
if(isset($_POST['cPassword'])){
  ...
  if(!empty($errors)){
    ...
    //change password
        $db->query("UPDATE customer_user SET password = '$new_hashed' WHERE id = '$user_id'");
...
<form action="change_password.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="submit" value="Change password" name="cPassword" class="btn btn-primary btn-lg">
  </div>
</form>
<p class="text-right"><a href="/ecommerce/index" alt="home">Return to Home Page<a><p/>
</div>
