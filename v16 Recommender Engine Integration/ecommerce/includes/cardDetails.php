...
<div class="form-group col-md-3">
  ...
  <input type="text" id="number" class="form-control" placeholder="e.g 4242 4242 4242 4242" data-stripe = "number">
</div>
<div class="form-group col-md-2">
  <label for="cvc">CVC</label>
  <input type="text" id="cvc" class="form-control" placeholder="e.g 123" data-stripe = "cvc">
</div>
<div class="form-group col-md-2">
