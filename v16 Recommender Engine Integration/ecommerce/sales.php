          ...
          if(isset($querySales) &&  $querySales->num_rows > 0){ ?>
              <div class="posts_list">
                  ...
                  <form action="productDetails.php">
                    ...
                    <input type="hidden" name="productDetails" value="filename_or_unique_id_of_img.jpg">
                   </form>
                       ...
                       <div class="imgHolder">
                         <img onclick="detailsmodal('add',<?= $product['id']; ?>)" src="<?= $photos[0]; ?>" alt="<?= $product['title']; ?>" class="img-thumb" style="width:100%"/>
                          <?php if ($product['sales'] == 1): ?>
                            <span>
                              <button name="<?= $product['id']; ?>"type ="button" id="signinButton" class="btn btn-xs btn-danger pull-left" onclick="detailsmodal(<?= $product['id']; ?>)">Sales</button>
                            </span>
                         <?php endif; ?>
                       </div>
