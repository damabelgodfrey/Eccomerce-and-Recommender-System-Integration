...
echo "<script type='text/javascript'>alert('$message');</script>";
  ...
  <?php } ?>
       <div class="container-fluid">
        <div id='success'> </div>
        <a href="index.php" class="btn btn-lg btn-success form-control"> Transaction Complete Continue Shopping</a>
      </div>
    <?php
...
<div class="container-fluid">
    <div id='success'> </div>
    <a href="index.php" class="btn btn-lg btn-success form-control"> Continue Shopping</a>
  </div>
