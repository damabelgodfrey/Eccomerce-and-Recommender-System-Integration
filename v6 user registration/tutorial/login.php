...
<style>
body{
  background-image: url("/tutorial/images/headerlogo/login-image.png");
...
if($_POST){
  ...
  if(!empty($errors)){
    ...
    //log user in
    $user_id = $user['id'];
    loginCustomer($user_id); //login function is in helpers file
  }
}
 ?>

</div>
<!--<img class = "display" src="/tutorial/images/headerlogo/login-image.png" alt=""> -->
...
<form action="login.php" method="post">
  ...
  <div class="form-group">
    ...
    <a href="register.php" class="btn btn-primary btn-lg"><span > Register</span></a>
  </div>
</form>
