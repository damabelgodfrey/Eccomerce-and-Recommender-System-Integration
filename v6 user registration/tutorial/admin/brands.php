...
if(isset($_GET['delete']) && !empty($_GET['delete'])){
  if(has_admin_permission('admin') || has_editor_permission('editor')){
    ...
    permission_ungranted('brands.php');
  }
}
...
<table class="table table-bordered table-striped table-auto table-condensed">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="brands.php?edit=<?=$brand['id']; ?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
      <a href="brands.php?delete=<?=$brand['id']; ?>" class="btn btn-danger btn-xs" onclick="return deleletconfirm()"><span class="glyphicon glyphicon-remove-sign"></span></a></td>
      <td><?=$brand['brand']; ?></td>
  </tr>
  <?php endwhile; ?>
  </tbody>
