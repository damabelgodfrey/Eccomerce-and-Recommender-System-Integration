    ...
    <!-- if edit is clicked set the post option to edit id else set to add product( add=1)-->
      <form action="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="POST" enctype="multipart/form-data">
        <div class="form-group col-md-3">
          ...
          <input type="text" name="title" class="form-control" id="title" value="<?=$title?>" maxlength="20">
        </div>
        <div class="form-group col-md-3">
       ...
       <div class="form-group col-md-3">
         ...
         <input type="number" pattern="![^0-9]" id="price" name="price" class="form-control" value="<?=$price;?>">
       </div>
       <!--List Price label -->
       <div class="form-group col-md-3">
         <label for="list_price">List Price:</label>
         <input type="number" id="list_price" name="list_price" class="form-control" value="<?=$list_price;?>">
       </div>
  ...
  ?>
    <tr>
        <td>
          ...
          <a href ="products.php?archive=<?=$product['id'];?>" class= "btn btn-xs btn-warning" onclick="return deleletconfirm()"><span class="glyphicon glyphicon-off"></span><a/>
        </td>
      <td><?=$product['title'];?></td>
